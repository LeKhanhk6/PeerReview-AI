...
export const AuthIllustrationPanel: React.FC<AuthIllustrationPanelProps> = ({
  ...
  return (
    <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-50/90 via-slate-50 to-brand-soft-bg/80 border-r border-slate-100/80 p-8 lg:p-12 flex-col justify-between relative overflow-hidden text-slate-900">
      ...
      {/* Center Official Logo Display (Matching Registerwithlogo.png mockup) */}
      <div className="relative z-10 my-auto py-6 flex flex-col items-center justify-center">
        <img
          ...
          className="max-w-[300px] lg:max-w-[350px] w-full h-auto object-contain drop-shadow-md hover:scale-105 transition-transform duration-300"
        />
      </div>

      {/* Bottom Tagline Badge */}
      <div className="relative z-10">
        <div className="inline-flex items-center gap-2 text-xs font-bold text-brand-heavy-text bg-white/90 backdrop-blur-md px-4 py-2 rounded-xl border border-brand-soft-border shadow-sm">
      ...
      <svg
        className="absolute -bottom-16 -left-16 w-64 h-64 opacity-30 pointer-events-none"
        viewBox="0 0 200 200"
        fill="none"
